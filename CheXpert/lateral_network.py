...
training_set = pd.read_csv("CheXpert-v1.0-small/csv/top/train_top_lateral.csv")
...
dataframe_train = training_set[:900]
...
test_set = pd.concat([training_set[900:], valid_set])
